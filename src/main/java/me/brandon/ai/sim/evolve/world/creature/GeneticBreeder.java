...
//		focusedCreature.numFeelers = (int) Math.min(maxFeelers, mutate(focusedCreature.numFeelers, mut_feelerCount, 2));
//		focusedCreature.numFeelers = Math.max(1, Math.min(maxFeelers, focusedCreature.numFeelers));
